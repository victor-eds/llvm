...
module attributes {gpu.container_module} {
  // CHECK:   gpu.module @kernels {
    //CHECK-DAG:      llvm.mlir.global external constant @__builtin_var_SubgroupLocalInvocationId__() {addr_space = 1 : i32} : i64
    //CHECK-DAG:      llvm.mlir.global external constant @__builtin_var_SubgroupMaxSize__() {addr_space = 1 : i32} : i64
    //CHECK-DAG:      llvm.mlir.global external constant @__builtin_var_GlobalOffset__() {addr_space = 1 : i32} : vector<3xi64>
    //CHECK-DAG:      llvm.mlir.global external constant @__builtin_var_SubgroupId__() {addr_space = 1 : i32} : i64
    //CHECK-DAG:      llvm.mlir.global external constant @__builtin_var_SubgroupSize__() {addr_space = 1 : i32} : i64
    //CHECK-DAG:      llvm.mlir.global external constant @__builtin_var_NumSubgroups__() {addr_space = 1 : i32} : i64
    //CHECK-DAG:      llvm.mlir.global external constant @__builtin_var_WorkgroupId__() {addr_space = 1 : i32} : vector<3xi64>
    //CHECK-DAG:      llvm.mlir.global external constant @__builtin_var_WorkgroupSize__() {addr_space = 1 : i32} : vector<3xi64>
    //CHECK-DAG:      llvm.mlir.global external constant @__builtin_var_LocalInvocationId__() {addr_space = 1 : i32} : vector<3xi64>
    //CHECK-DAG:      llvm.mlir.global external constant @__builtin_var_GlobalInvocationId__() {addr_space = 1 : i32} : vector<3xi64>
    //CHECK-DAG:      llvm.mlir.global external constant @__builtin_var_NumWorkgroups__() {addr_space = 1 : i32} : vector<3xi64>
    //CHECK-DAG:      llvm.mlir.global external constant @__builtin_var_GlobalSize__() {addr_space = 1 : i32} : vector<3xi64>
  gpu.module @kernels {
    ...
    // CHECK-NEXT:        %[[VAL_0:.*]] = llvm.mlir.addressof @__builtin_var_GlobalSize__ : !llvm.ptr<vector<3xi64>, 1>
    // CHECK-NEXT:        %[[VAL_1:.*]] = llvm.load %[[VAL_0]] : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_16:.*]] = llvm.mlir.addressof @__builtin_var_GlobalSize__ : !llvm.ptr<vector<3xi64>, 1>
    // CHECK-NEXT:        %[[VAL_17:.*]] = llvm.load %[[VAL_16]] : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_32:.*]] = llvm.mlir.addressof @__builtin_var_GlobalInvocationId__ : !llvm.ptr<vector<3xi64>, 1>
    // CHECK-NEXT:        %[[VAL_33:.*]] = llvm.load %[[VAL_32]] : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_53:.*]] = llvm.mlir.addressof @__builtin_var_GlobalInvocationId__ : !llvm.ptr<vector<3xi64>, 1>
    // CHECK-NEXT:        %[[VAL_54:.*]] = llvm.load %[[VAL_53]] : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_69:.*]] = llvm.mlir.addressof @__builtin_var_LocalInvocationId__ : !llvm.ptr<vector<3xi64>, 1>
    // CHECK-NEXT:        %[[VAL_70:.*]] = llvm.load %[[VAL_69]] : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_95:.*]] = llvm.mlir.addressof @__builtin_var_LocalInvocationId__ : !llvm.ptr<vector<3xi64>, 1>
    // CHECK-NEXT:        %[[VAL_96:.*]] = llvm.load %[[VAL_95]] : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_111:.*]] = llvm.mlir.addressof @__builtin_var_WorkgroupSize__ : !llvm.ptr<vector<3xi64>, 1>
    // CHECK-NEXT:        %[[VAL_112:.*]] = llvm.load %[[VAL_111]] : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_137:.*]] = llvm.mlir.addressof @__builtin_var_WorkgroupSize__ : !llvm.ptr<vector<3xi64>, 1>
    // CHECK-NEXT:        %[[VAL_138:.*]] = llvm.load %[[VAL_137]] : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_153:.*]] = llvm.mlir.addressof @__builtin_var_WorkgroupId__ : !llvm.ptr<vector<3xi64>, 1>
    // CHECK-NEXT:        %[[VAL_154:.*]] = llvm.load %[[VAL_153]] : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_169:.*]] = llvm.mlir.addressof @__builtin_var_WorkgroupId__ : !llvm.ptr<vector<3xi64>, 1>
    // CHECK-NEXT:        %[[VAL_170:.*]] = llvm.load %[[VAL_169]] : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_200:.*]] = llvm.mlir.addressof @__builtin_var_NumSubgroups__ : !llvm.ptr<i64, 1>
    ...
    // CHECK-NEXT:        %[[VAL_203:.*]] = llvm.mlir.addressof @__builtin_var_SubgroupSize__ : !llvm.ptr<i64, 1>
    ...
    // CHECK-NEXT:        %[[VAL_206:.*]] = llvm.mlir.addressof @__builtin_var_SubgroupId__ : !llvm.ptr<i64, 1>
    ...
    // CHECK-NEXT:        %[[VAL_194:.*]] = llvm.mlir.addressof @__builtin_var_GlobalOffset__ : !llvm.ptr<vector<3xi64>, 1>
    // CHECK-NEXT:        %[[VAL_195:.*]] = llvm.load %[[VAL_194]] : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_223:.*]] = llvm.mlir.addressof @__builtin_var_GlobalOffset__ : !llvm.ptr<vector<3xi64>, 1>
    // CHECK-NEXT:        %[[VAL_224:.*]] = llvm.load %[[VAL_223]] : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_226:.*]] = llvm.mlir.addressof @__builtin_var_NumWorkgroups__ : !llvm.ptr<vector<3xi64>, 1>
    // CHECK-NEXT:        %[[VAL_227:.*]] = llvm.load %[[VAL_226]] : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_247:.*]] = llvm.mlir.addressof @__builtin_var_NumWorkgroups__ : !llvm.ptr<vector<3xi64>, 1>
    // CHECK-NEXT:        %[[VAL_248:.*]] = llvm.load %[[VAL_247]] : !llvm.ptr<vector<3xi64>, 1>
    ...
    // CHECK-NEXT:        %[[VAL_273:.*]] = llvm.mlir.addressof @__builtin_var_SubgroupMaxSize__ : !llvm.ptr<i64, 1>
    ...
    // CHECK-NEXT:        %[[VAL_276:.*]] = llvm.mlir.addressof @__builtin_var_SubgroupLocalInvocationId__ : !llvm.ptr<i64, 1>
